...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    bronzePathway: 'Bronze Pathway', assignBronze: 'Assign to Bronze', bronzeMember: 'Bronze Member', ecosystemNote: 'Every applicant joins FORSA. Gold & Silver receive a tuition facilitation plan. Bronze receives ecosystem access and priority.',
    membershipQueue: 'Membership Queue', financingQueue: 'Tuition Facilitation Queue', aiQueue: 'AI Queue', waitingList: 'Waiting List', digitalPass: 'Digital Pass', fraudRecords: 'Fraud Records',
  ...
  fr: {
    ...
    membershipQueue: 'File adhésion', financingQueue: 'File facilitation des frais', aiQueue: 'File IA', waitingList: "Liste d'attente", digitalPass: 'Pass numérique', fraudRecords: 'Dossiers de fraude',
  ...
  ar: {
    ...
    membershipQueue: 'قائمة العضوية', financingQueue: 'قائمة خطط التيسير', aiQueue: 'قائمة الذكاء الاصطناعي', waitingList: 'قائمة الانتظار', digitalPass: 'البطاقة الرقمية', fraudRecords: 'سجلات الاحتيال',
